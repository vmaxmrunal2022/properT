                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Superadmin</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Login</span>
                            </span>
                        </span>
                    </button>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-light_dash.png" alt="" height="40">
                    </span>
                </a>
                ...
                <div class="container-fluid">
                    ...
                    <div id="two-column-menu">
                     ...
                     <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="forms-elements.html"  role="button" aria-expanded="false" aria-controls="sidebarDashboards">
						...
						<li class="nav-item">
                            <a class="nav-link menu-link" href="reports.html"   role="button" aria-expanded="false" aria-controls="sidebarDashboards">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!--            <h4 class="mb-sm-0">Property Added Successfully</h4>-->
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © ProperT.
                        </div>
                        <div class="col-sm-6">

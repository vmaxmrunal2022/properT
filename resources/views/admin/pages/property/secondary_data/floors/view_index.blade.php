        ...
        <div class="col-xl-12 col-md-12">
            ...
            <div class="">
                ...
                <div class="card-body primary-block">
                    ...
                    {{-- <div class=" text-end">
                        <button type="submit" class="btn btn-primary waves-effect waves-light" id="create_property_btn">Save</button>
                        <button type="button" class="btn btn-primary waves-effect waves-light floors-next-btn"> Procced</button>
                    </div> --}}
                </div>

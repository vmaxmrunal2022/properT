    ...
    .addpuls {
     ...
     .apart-images img {
        ...
        .remove-image {
            ...
            font: 700 21px/20px sans-serif !important;
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="card d-none" style="" id="showTabsCompliances">
                        <div class="card-body ">
                                    ...
                                    <div class="row ">
                                       <div class="col-xxl-3 col-md-3 mb-3">
                                            <div>
                                                ...
                                                <label for="block_tower_id" class="form-label">Select Block/Tower</label>
          ...
          $(document).ready(function() {
            if (window.File && window.FileList && window.FileReader) {
             $(".file-input").on("change", function(e) {
                ...
                fileReader.onload = (function(file, fileExtension) {
                    return function(e) {
                    var imageThumb;
                    if (allowedExtensions.includes(fileExtension)) {
                        imageThumb = $("<img>").addClass("imageThumb").attr("src", e.target.result).attr("width", "130");
                    } else if (videoExtensions.includes(fileExtension)) {
                        imageThumb = $("<i>").addClass("fas fa-video").css({"font-size": "100px", "color": "white", "padding": "10px"});
                    } else if (pdfExtensions.includes(fileExtension)) {
                        imageThumb = $("<i>").addClass("fas fa-file-pdf").css({"font-size": "100px", "color": "white", "padding": "10px"});
                    }

	...
	<div class="row  commercial-fields-child ">
		...
		<div class="col-xxl-3 col-md-3 mt-3">
			<div>
				...
				<input disabled type="text" value="{{$property->building_name ?? ''}}" name="building_name" class="form-control" id="">
			</div>
		</div>
		<div class="col-xxl-3 col-md-3 mt-3">
			<div>
		...
		<div class="col-xxl-3 col-md-3 mt-3">
			<div>
				...
				<input disabled type="text" value="{{$property->plot_no ?? ''}}" name="plot_no" class="form-control" id="" readonly>
			</div>
		</div>
		<div class="col-xxl-3 col-md-3 mt-3">
			<div>

        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Other Commercial Details </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <form id="SubmitPropertyDetails" method="POST">
                                <div class=" screen visible">
                                    <div class="card1">
                                        ...
                                        <label class="form-label ">Property Facing  <span id="errcarpet_area"></span></label>
                                        ...
                                        <label class="form-label ">Availability Status  <span id="errcarpet_area"></span></label>
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar-text">
                    ...
                    if (jqXHR.status == 422) {
                        for (const [key, value] of Object.entries(jqXHR.responseJSON.errors)) {
                            if (key != 'property_facing' && key != 'pantry' && key != 'conference_room' && key != 'reception_area' &&
                                ...
                                key != 'lift' && key != 'availability_status' && key != 'property_age' && key != 'carpet_area' &&
                                key != 'staircase') {

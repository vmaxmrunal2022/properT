                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center mt-3 mb-3">
                                                <div class="col-md-4">
                                                    <div class="box-bdr">
                                                        <div class="d-flex">
                                                            <div>
                                                                <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none" name="plot_area" id="" placeholder="Plot Area "/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 d-flex align-items-center mt-1">
                                                    <input class="form-control " type="text" name="plot_length" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  placeholder="Length of Plot (in Ft.)">
                                                </div>

                                                <div class="col-md-3 d-flex align-items-center mt-1">
                                                    <input class="form-control " type="text" name="plot_breadth" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder=" Breadth of Plot (in Ft.)">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <input class="form-control" name="floors_allowed" type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="No. of Floors">
                                            </div>

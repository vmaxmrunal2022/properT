                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" placeholder="Enter bedrooms" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_bedrooms" id="other-bedrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-start mb-3">
                                            ...
                                            <div class="col-md-2 other-balcony-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" maxlength="11" placeholder="Enter Balconies" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_balconies" id="other-balconies">
                                            </div>
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none required-text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="carpet_area" id="" placeholder="carpet area">
                                                        </div>
                                            ...
                                            <div class="col-md-4 built-area-block" style="display: none;">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="built_area" id="" placeholder="Add Built up area">
                                                        </div>
                                                        <div class="ms-auto" style="">

                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="bedrooms1" name="rooms" value="1" @if( $secondary_level_unit_data->rooms == 1) checked @endif>
                                                    <label for="bedrooms1">1</label>
                                                    <input type="radio" id="bedrooms2" name="rooms" value="2" @if( $secondary_level_unit_data->rooms == 2) checked @endif>
                                                    <label for="bedrooms2">2</label>
                                                    <input type="radio" id="bedrooms3" name="rooms" value="3" @if( $secondary_level_unit_data->rooms == 3) checked @endif>
                                                    <label for="bedrooms3">3</label>
                                                    <input type="radio" id="bedrooms4" name="rooms" value="4" @if( $secondary_level_unit_data->rooms == 4) checked @endif>
                                                    <label for="bedrooms4">4</label>
                                                    @if($secondary_level_unit_data->rooms > 4)
                                                    <input type="radio" id="bedrooms5" name="rooms" value="{{$secondary_level_unit_data->rooms}}"  checked>
                                                    <label for="bedrooms5">{{$secondary_level_unit_data->rooms}}</label>
                                                    @endif
                                                    <div class="extra-bedrooms-block" style="display: none;">
                                                        <input type="radio" id="extra-bedrooms-input" name="rooms" value="">
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" placeholder="Enter rooms"  maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_rooms" id="other-bedrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-start mb-3">
                                            ...
                                            <div class="col-md-2 other-washrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" placeholder="Enter washrooms"  maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_washrooms" id="other-washrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text"  maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{$secondary_level_unit_data->carpet_area ?? ''}}" name="carpet_area" id="" placeholder="carpet area">
                                                        </div>

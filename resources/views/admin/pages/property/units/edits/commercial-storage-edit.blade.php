                            ...
                            <form id="SubmitPropertyDetails" method="post">
                                ...
                                <div class=" screen visible">
                                    ...
                                    <div class="row align-items-start mb-3">
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-md-12 mb-3">
                                                    <div class="radio-toolbar" id="AppendStaricase">
                                                        <input type="radio" id="radio2" name="no_of_bathrooms" value="1"  @if($secondary_level_unit_data->no_of_bathrooms == 1) checked @endif>
                                                        <label for="radio2">1</label>
                                                        <input type="radio" id="radio3" name="no_of_bathrooms" value="2" @if($secondary_level_unit_data->no_of_bathrooms == 2) checked @endif>
                                                        <label for="radio3">2</label>
                                                        <input type="radio" id="radio4" name="no_of_bathrooms" value="3" @if($secondary_level_unit_data->no_of_bathrooms == 3) checked @endif>
                                                        <label for="radio4">3</label>
                                                        <input type="radio" id="radio5" name="no_of_bathrooms" value="4" @if($secondary_level_unit_data->no_of_bathrooms == 4) checked @endif>
                                                        <label for="radio5">4</label>
                                                        @if($secondary_level_unit_data->no_of_bathrooms > 4)
                                                        <input type="radio" id="bedrooms5" name="no_of_bathrooms" value="{{$secondary_level_unit_data->no_of_bathrooms}}"  checked>
                                                        <label for="bedrooms5">{{$secondary_level_unit_data->no_of_bathrooms}}</label>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="11" style="display:none" onkeypress="return isNumber(event)"  class="form-control col-md-3" id="ExtraStaircase">
                                        </div>

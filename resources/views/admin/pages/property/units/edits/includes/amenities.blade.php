                ...
                <div class="mt-4 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="box-bdr">
                            <div class="d-flex">
                                <div>
                                    <input type="text" class="form-control form-control-b0 col-md-3 border-none"  maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{$secondary_level_unit_data->facing_road_width ?? ''}}" name="facing_road_width" placeholder="">
                                </div>
                                <div class="ms-auto" style="">
                                    <select class="form-select form-control-b0" name="facing_road_width_unit">
                                        @forelse($units as $unit)

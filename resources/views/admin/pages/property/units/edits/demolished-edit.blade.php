        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Demolished</h4>
                    ...
                    <div class="">
                        ...
                        <div class="row align-items-center mt-3 mb-3">
                            <div class="col-md-4">
                                <div class="box-bdr">
                                    <div class="d-flex">
                                        <div>
                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none" value="{{$secondary_level_unit_data->plot_area}}" onkeypress="return isNumber(event)" name="plot_area" id="CarpetArea" placeholder="Plot area">
                                        </div>
                            ...
                            <div class="col-md-4" id="BuiltUp" @if($secondary_level_unit_data->carpet_area == null) style="display: none;" @endif>
                                <div class=" box-bdr">
                                    <div class="d-flex">
                                        <div>
                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none" value="{{$secondary_level_unit_data->carpet_area}}" name="carpet_area" onkeypress="return isNumber(event)" id="BuildupArea" placeholder="Add Carpet area">
                                        </div>
                                        <div class="ms-auto" style="">
                            ...
                            <div class="col-md-4" id="SuperBuiltUp" @if($secondary_level_unit_data->buildup_area == null) style="display: none;" @endif>
                                <div class="box-bdr">
                                    <div class="d-flex">
                                        <div>
                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none" value="{{$secondary_level_unit_data->buildup_area}}" onkeypress="return isNumber(event)" name="buildup_area" id="SuperBuildupArea" placeholder="Add Built up area">
                                        </div>
                                        <div class="ms-auto" style="">
                        ...
                        <div class="row">
                            <div class="col-md-4 d-flex align-items-center mt-1">
                                <input class="form-control " type="text" maxlength="11" onkeypress="return isNumber(event)" value="{{$secondary_level_unit_data->previous_use}}" name="previous_use" placeholder="Length of Plot (in Ft.)">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 d-flex align-items-center mt-1">
                                <input class="form-control " type="text" maxlength="11" onkeypress="return isNumber(event)" value="{{$secondary_level_unit_data->current_use}}" name="current_use" placeholder="Length of Plot (in Ft.)">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 d-flex align-items-center mt-1">
                                <input class="form-control " maxlength="11" onkeypress="return isNumber(event)"  type="text" name="price" value="{{$secondary_level_unit_data->price}}" placeholder="Length of Plot (in Ft.)">
                            </div>
                        </div>

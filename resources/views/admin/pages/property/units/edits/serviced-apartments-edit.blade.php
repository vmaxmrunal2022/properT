                                ...
                                <form id="SubmitPropertyDetails" method="POST">
                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="bedrooms1" name="bedrooms" value="1" @if( $secondary_level_unit_data->rooms == 1) checked @endif>
                                                    <label for="bedrooms1">1</label>
                                                    <input type="radio" id="bedrooms2" name="bedrooms" value="2" @if( $secondary_level_unit_data->rooms == 2) checked @endif>
                                                    <label for="bedrooms2">2</label>
                                                    <input type="radio" id="bedrooms3" name="bedrooms" value="3" @if( $secondary_level_unit_data->rooms == 3) checked @endif>
                                                    <label for="bedrooms3">3</label>
                                                    <input type="radio" id="bedrooms4" name="bedrooms" value="4" @if( $secondary_level_unit_data->rooms == 4) checked @endif>
                                                    <label for="bedrooms4">4</label>
                                                    @if($secondary_level_unit_data->rooms > 4)
                                                    <input type="radio" id="bedrooms5" name="bedrooms" value="{{$secondary_level_unit_data->rooms}}"  checked>
                                                    <label for="bedrooms5">{{$secondary_level_unit_data->rooms}}</label>
                                                    @endif
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" maxlength="11" class="form-control col-md-3" placeholder="Enter bedrooms" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_bedrooms" id="other-bedrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="washrooms1" name="washrooms" value="1" @if( $secondary_level_unit_data->washrooms == 1) checked @endif>
                                                    <label for="washrooms1">1</label>
                                                    <input type="radio" id="washrooms2" name="washrooms" value="2" @if( $secondary_level_unit_data->washrooms == 2) checked @endif>
                                                    <label for="washrooms2">2</label>
                                                    <input type="radio" id="washrooms3" name="washrooms" value="3" @if( $secondary_level_unit_data->washrooms == 3) checked @endif>
                                                    <label for="washrooms3">3</label>
                                                    <input type="radio" id="washrooms4" name="washrooms" value="4" @if( $secondary_level_unit_data->washrooms == 4) checked @endif>
                                                    <label for="washrooms4">4</label>
                                                    @if($secondary_level_unit_data->washrooms > 4)
                                                    <input type="radio" id="washrooms5" name="washrooms" value="{{$secondary_level_unit_data->washrooms}}"  checked>
                                                    <label for="washrooms5">{{$secondary_level_unit_data->washrooms}}</label>
                                                    @endif
                                            ...
                                            <div class="col-md-2 other-washrooms-block" style="display: none;">
                                                <input type="text" maxlength="11" class="form-control col-md-3" placeholder="Enter washrooms" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_washrooms" id="other-washrooms">
                                            </div>
                                        ...
                                        <div class="radio-toolbar-text">
                                            ...
                                            <input type="radio" id="property_facing{{$facing->id}}" name="property_facing"  @if($secondary_level_unit_data->property_facing == $facing->id) checked @endif value="{{$facing->id}}">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="balcony1" name="balconies" value="1" @if($secondary_level_unit_data->balconies == 1) checked @endif>
                                                    <label for="balcony1">1</label>
                                                    <input type="radio" id="balcony2" name="balconies" value="2" @if($secondary_level_unit_data->balconies == 2) checked @endif>
                                                    <label for="balcony2">2</label>
                                                    <input type="radio" id="balcony3" name="balconies" value="3" @if($secondary_level_unit_data->balconies == 3) checked @endif>
                                                    <label for="balcony3">3</label>
                                                    <input type="radio" id="balcony4" name="balconies" value="4" @if($secondary_level_unit_data->balconies == 4) checked @endif>
                                                    <label for="balcony4">4</label>
                                                    @if($secondary_level_unit_data->balconies > 4)
                                                    <input type="radio" id="balcony4" name="balconies" value="{{$secondary_level_unit_data->balconies}}"  checked>
                                                    <label for="balcony4">{{$secondary_level_unit_data->balconies}}</label>
                                                    @endif
                                            ...
                                            <div class="col-md-2 other-balcony-block" style="display: none;">
                                                <input type="text" maxlength="11" class="form-control col-md-3" placeholder="Enter Balconies" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_balconies" id="other-balconies">
                                            </div>
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none required-text" value="{{$secondary_level_unit_data->carpet_area ?? ''}}" name="carpet_area" id="" placeholder="carpet area">
                                                        </div>
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0 border-left" name="carpet_area_units">
                                                                ...
                                                                <option value="{{$area_units->id}}" @if($secondary_level_unit_data->carpet_area_unit == $area_units->id)  selected @endif>{{$area_units->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="clearfix mb-3"></div>
                                            <div class="col-md-4 built-area-block"  @if($secondary_level_unit_data->buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text"  value="{{$secondary_level_unit_data->buildup_area ?? ''}}"  name="built_area" id="" placeholder="Add Built up area">
                                                        </div>
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0" name="builtup_area_units">
                                                                @foreach ($units as $area_units)
                                                                <option value="{{$area_units->id}}"  @if($secondary_level_unit_data->buildup_area_unit == $area_units->id)  selected @endif>{{$area_units->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="clearfix mb-3"></div>
                                            <div class="col-md-4 super-built-area-block"  @if($secondary_level_unit_data->super_buildup_area == null) style="display: none;" @endif>
                                                <div class="box-bdr" >
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text"  value="{{$secondary_level_unit_data->super_buildup_area ?? ''}}" name="super_built_area" id="" placeholder="Add Super Built up area">
                                                        </div>
                                                        <div class="ms-auto" style="">
                                                            <select class="form-select form-control-b0" name="super_built_area_units">
                                                                @foreach ($units as $area_units)
                                                                <option value="{{$area_units->id}}"  @if($secondary_level_unit_data->super_buildup_area_unit == $area_units->id)  selected @endif>{{$area_units->name}}</option>
                                                            @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="add-built-area"  @if($secondary_level_unit_data->buildup_area != null) style="display: none;" @endif>
                                                        <a style="color: var(--vz-link-color);"> + Add Built up area</a>
                                                    </div>
                                                
                                                    <div class="add-super-built-area"  @if($secondary_level_unit_data->super_buildup_area != null) style="display: none;" @endif>
                                                        <a style="color: var(--vz-link-color);"> + Add Super Built up area</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="radio-toolbar-text mt-3">
                                            @foreach ($other_rooms as $room)
                                                <div class="col-md-2 simplecheck mb-3">
                                                    <span><input type="checkbox" name="other_rooms[]" @if(in_array( $room->id,$other_room_values)) checked @endif value="{{$room->id}}" value="{{$room->id}}"> {{$room->name}}</span>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="clearfix mb-3"></div>
                                        ...
                                        <div class="radio-toolbar-text Furn-semi mt-3">
                                            ...
                                            @foreach ($furnished_options as $furnish)
                                                ...
                                                <div>
                                                    <input type="radio" id="furnished-option{{$furnish->id}}" name="furnished_option"  @if($furnish->id == $secondary_level_unit_data->furnishing_option) checked @endif value="{{$furnish->id}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                    <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="input-step step-primary float-left mr-2">
                                                            <button type="button" class="minus">–</button>
                                                            <input type="number" class="product-quantity" value="{{$secondary_level_unit_data->covered_parking ?? '1'}}" name="covered_parking" min="0" max="100" readonly="">
                                                            <button type="button" class="plus">+</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        <button type="button" class="minus">–</button>
                                                        <input type="number" class="product-quantity" value="{{$secondary_level_unit_data->open_parking ?? '1'}}" name="open_parking" min="0" max="100" readonly="">
                                                        <button type="button" class="plus">+</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="radio-toolbar-text">
                                            @foreach ($availability_status as $availability)
                                                <input type="radio" class="availability_status_radio" id="availibility_status{{$availability->id}}"  @if($availability->id == $secondary_level_unit_data->availability_status) checked @endif name="availability_status"  value="{{$availability->id}}" onclick="ShowBlocks({{$availability->id}})">
                                        ...
                                        <div class="clearfix mb-3"></div>
                                        <div class="age-of-property-block" @if($secondary_level_unit_data->availability_status != 23) style="display: none;" @endif>
                                            <label class="form-label mb-0 required">Age of Property</label>
                                            <div class="radio-toolbar-text">
                                                @foreach ($age_props as $prop)
                                                    <input type="radio" id="age_prop{{$prop->id}}" name="age_of_property"  @if($secondary_level_unit_data->age_of_property == $prop->id) checked @endif value="{{$prop->id}}">
                                        ...
                                        <div class="clearfix mb-3"></div>
                                        <div class="possession-block" @if($secondary_level_unit_data->availability_status != 24) style="display: none;" @endif>
                                            <label class="form-label m-0 required">Possesion by</label>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="date" class="form-control" value="{{ \Carbon\Carbon::parse($secondary_level_unit_data->possesion_by)->format('Y-m-d') }}" name="possession_date" />
                                                </div>
                                            ...
                                            <div class="for-sale">
                                                ...
                                                <div class="price-details-block">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-md-4">
                                                            <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control required-sale" id="" value="{{$secondary_level_unit_data->expected_price ?? ''}}"
                                                                name="expected_price" placeholder="Expected Price">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control required-sale" id="" value="{{$secondary_level_unit_data->price_per_sq_ft ?? ''}}"
                                                ...
                                                <div class="mt-4 mb-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="box-bdr">
                                                            <div class="d-flex">
                                                                <div>
                                                                    <input type="text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none"  value="{{$secondary_level_unit_data->facing_road_width ?? ''}}" name="facing_road_width" placeholder="">
                                                                </div>
                                                                <div class="ms-auto" style="">
         ...
         // ------------------------------------  next and previous scripts  ---------------------------------- //
            ...
            $('form[id=PricingDetailsForm]').submit(function(e) {
             ...
             //   alert(currentScreen);
                ...
                $.ajax({
                    url: "{{ route('surveyor.property.unit_details.resedential.serviced_apartments.store_pricing_details') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },

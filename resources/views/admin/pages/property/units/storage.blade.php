...
@push('css')
<link href="{{ asset('assets/css/unit-details.css') }}?v=2372" rel="stylesheet" type="text/css" />
@endpush
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-md-12 mb-3">
                                                    <div class="radio-toolbar" id="AppendStaricase">
                                                        <input type="radio" id="radio2" name="no_of_bathrooms" value="1">
                                                        <label for="radio2">1</label>
                                                        <input type="radio" id="radio3" name="no_of_bathrooms" value="2">
                                                        <label for="radio3">2</label>
                                                        <input type="radio" id="radio4" name="no_of_bathrooms" value="3">
                                                        <label for="radio4">3</label>
                                                        <input type="radio" id="radio5" name="no_of_bathrooms" value="4">
                    ...
                    if (jqXHR.status == 422) {
                        for (const [key, value] of Object.entries(jqXHR.responseJSON.errors)) {
                            if (key != 'property_facing' && key != 'parking_type' && key != 'washrooms' &&
                                key != 'availability_status' && key != 'property_age' && key != 'no_of_bathrooms' && key != 'carpet_area') {

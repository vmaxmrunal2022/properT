...
@push('css')
<link href="{{ asset('assets/css/unit-details.css') }}?v=2375" rel="stylesheet" type="text/css" />
@endpush
                                    ...
                                    <div class="row align-items-center mt-3 mb-3 area-details-block">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" maxlength="11"  onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-b0 col-md-3 border-none required-text" name="carpet_area" id="" placeholder="carpet area">
                                                    </div>
                                        ...
                                        <div class="col-md-4 built-area-block" style="display: none;">
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" class="form-control form-control-b0 col-md-3 border-none required-text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="built_area" id="" placeholder="Add Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                        ...
                                        <div class="col-md-4 super-built-area-block" style="display: none;">
                                            <div class="box-bdr">
                                                <div class="d-flex">
                                                    <div>
                                                        <input type="text" class="form-control form-control-b0 col-md-3 border-none required-text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="super_built_area" id="" placeholder="Add Super Built up area">
                                                    </div>
                                                    <div class="ms-auto" style="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                        <div class="input-step step-primary float-left mr-2">
                                                            ...
                                                            <input type="number" class="product-quantity" value="1" name="{{str_replace([' ', '-'], '_', $furnish->name)}}_{{str_replace([' ', '-'], '_', $option->name)}}" min="0" maxlength="100" readonly="">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="for-sale">
                                            ...
                                            <div class="price-details-block">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control required-sale" id="" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="expected_price" placeholder="Expected Price">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control required-sale" id="" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="price_per_sq_ft" placeholder="Price per Sq feet">
                                                    </div>
                                            ...
                                            <div class="add-price-details-block">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="box-bdr">
                                                            <div class="row d-flex">
                                                                <div class="col-md-7">
                                                                    <input type="text" class="form-control form-control-b0 border-none" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_maintenance_price" id="" placeholder="Maintenance">
                                                                </div>
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        <input type="text" class="form-control border-none" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_expected_rental" id="" placeholder="Expected Rental">
                                                    </div>

                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_booking_amount" id="" placeholder="Booking Amount">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_annual_dues_payable" id="" placeholder="Annual dues payble">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control border-none" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="pricing_membership_charge" id="" placeholder="Membership Charge">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="for-rent">
                                            ...
                                            <div class="rent-details-block">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control required-rent" id="" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="expected_rent" placeholder="Expected Rent">
                                                    </div>
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-md-4">
                                                                <div class="box-bdr">
                                                                    <div class="row d-flex">
                                                                        <div class="col-md-7">
                                                                            <input type="text" class="form-control " maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" 
                                                            ...
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control  " maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="rent_booking_amount" id="" placeholder="Booking Amount ">
                                                            </div>
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control " maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="rent_annual_dues_payable" id="" placeholder="Annual Dues Payable  ">
                                                            </div>
                                                            <div class="col-md-3 ">
                                                                <input type="text" class="form-control " maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="rent_membership_charge" id="" placeholder="Membership Charge  ">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row images-block" style="display:block;">
                                                <div class="col-xxl-3 col-md-3 mb-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-column">
                                                            <input type="file" class="unit-images" name="gallery_images[]" id="files" multiple class="form-control file-input" style="display:none;">
                                                ...
                                                <div class="col-xxl-3 col-md-3 mb-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-column">
                                                            <input type="file" class="unit-images" name="amenities_images[]" id="AmenityFiles" multiple class="form-control file-input" style="display:none;">
                                                ...
                                                <div class="col-xxl-3 col-md-3 mb-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-column">
                                                            <input type="file" class="unit-images" name="interior_images[]" id="InteriorFiles" multiple class="form-control file-input" style="display:none;">
                                                ...
                                                <div class="col-xxl-3 col-md-3 mb-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-center flex-column">
                                                            <input type="file" class="unit-images" name="floor_plan_images[]" id="FloorPlanFiles" multiple class="form-control file-input" style="display:none;">
                                            ...
                                            <div class="mt-4 mb-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="box-bdr">
                                                        <div class="d-flex">
                                                            <div>
                                                                <input type="text" class="form-control form-control-b0 col-md-3 border-none" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="facing_road_width" placeholder="">
                                                            </div>
                                                            <div class="ms-auto" style="">

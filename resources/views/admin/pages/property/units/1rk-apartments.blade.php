...
@section('content')
    ...
    <link href="{{ asset('assets/css/unit-details.css') }}?v=2368" rel="stylesheet" type="text/css" />
                                ...
                                <form id="SubmitPropertyDetails" method="POST">
                                    ...
                                    <div class="screen visible">
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar"> 
                                                    <input type="radio" id="bedrooms1" name="bedrooms" value="1" checked>
                                            ...
                                            <div class="col-md-2 other-bedrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" placeholder="Enter bedrooms" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_bedrooms" id="other-bedrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-start mb-3">
                                            <div class="col-md-12 mb-3">
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="washrooms1" name="washrooms" value="1" checked>
                                            ...
                                            <div class="col-md-2 other-washrooms-block" style="display: none;">
                                                <input type="text" class="form-control col-md-3" placeholder="Enter washrooms" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="other_washrooms" id="other-washrooms">
                                            </div>
                                        ...
                                        <div class="row align-items-center mt-3 mb-3 area-details-block">
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="box-bdr">
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" class="form-control form-control-b0 col-md-3 border-none required-text" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="carpet_area" id="" placeholder="carpet area">
                                                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11"
                                                                class="form-control form-control-b0 col-md-3 border-none required-text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  name="built_area" id="" placeholder="Add Built up area">
                                                        </div>
                                                        <div class="ms-auto" style="">
                                            ...
                                            <div class="col-md-4 super-built-area-block" style="display: none;">
                                                <div class="box-bdr" >
                                                    <div class="d-flex">
                                                        <div>
                                                            <input type="text" maxlength="11" class="form-control form-control-b0 col-md-3 border-none required-text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="super_built_area" id="" placeholder="Add Super Built up area">
                                                        </div>
                                                        <div class="ms-auto" style="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                    <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="input-step step-primary float-left mr-2">
                                                            <button type="button" class="minus">–</button>
                                                            <input type="number" class="product-quantity" value="1" name="covered_parking" min="0" max="100" readonly="">
                                                            <button type="button" class="plus">+</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3 d-flex align-items-center mt-3">
                                                <div class="col-md-6 col-6 d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="input-step step-primary float-left mr-2">
                                                        <button type="button" class="minus">–</button>
                                                        <input type="number" class="product-quantity" value="1" name="open_parking" min="0" max="100" readonly="">
                                                        <button type="button" class="plus">+</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="for-sale">
                                                ...
                                                <div class="price-details-block">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control required-sale" id="" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                            ...
                                            <div class="for-rent">
                                                ...
                                                <div class="rent-details-block">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-md-4">
                                                            <input type="text" maxlength="11" class="form-control required-rent" id=""
                                                                name="expected_rent" placeholder="Expected Rent" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                                        </div>
